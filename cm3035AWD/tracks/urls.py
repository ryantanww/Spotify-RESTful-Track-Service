...
urlpatterns = [
    ...
    path('create_track/', views.TrackCreate.as_view(), name='create_track'),
    ...
    path('api/popular/', api.popular_tracks, name='popular_tracks'),
    path('api/high_energy_danceable/', api.high_energy_danceable_tracks, name='high_energy_danceable_tracks'),
]